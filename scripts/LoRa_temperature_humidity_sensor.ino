...
/* OTAA */
uint8_t devEui[] = {0x32, 0x32, 0x32, 0x00, 0x00, 0x00, 0x00, 0x23};
uint8_t appEui[] = { 0x11, 0x22, 0x33, 0x44, 0x55, 0x66, 0x77, 0x01 };
uint8_t appKey[] = { 0x68, 0x88, 0x88, 0x88, 0x88, 0x88, 0x88, 0x88, 0x88, 0x88, 0x88, 0x88, 0x88, 0x88, 0x88, 0x88};
...
uint32_t devAddr =  ( uint32_t )0x260BDF62;
